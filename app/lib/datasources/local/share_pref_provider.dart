import 'package:app/datasources/local/share_pref_name.dart';
...
class SharePrefProvider {
  ...
  SharePrefProvider(this.instance) {
  ...
  static Future<String> getToken() async => getString(SharePrefName.TOKEN);
